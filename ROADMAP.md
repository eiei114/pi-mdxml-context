...
- ~~Resolve the npm publish gap (0.1.3–0.1.5)~~ **Done** — 0.1.3–0.1.17 are on npm; publishing remains human-owned via `publish.yml`.
...
— registry latest matches the published package (`0.1.3`–`0.1.17` on npm via Trusted
