...
- ~~Resolve the npm publish gap (0.1.3–0.1.5)~~ **Done** — 0.1.3–0.1.16 are on npm; publishing remains human-owned via `publish.yml`.
...
— registry latest matches the published package (`0.1.3`–`0.1.16` on npm via Trusted
